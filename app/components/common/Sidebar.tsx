...
const sidebarItems: SidebarItem[] = [
  ...
  { id: "assets", label: "Assets", icon: FolderOpen, href: "/assets", requiresAuth: true }, // Only assets requires auth
  { id: "video-agent", label: "Video Agent", icon: Bot, href: "/video-agent", badge: "BETA", requiresAuth: false },
  { id: "templates", label: "Templates", icon: LayoutTemplate, href: "/templates", requiresAuth: false },
  { id: "image", label: "Image", icon: ImageIcon, href: "/image-generator", requiresAuth: false },
  { id: "video", label: "Video", icon: Video, href: "/ai-video-generator", badge: "NEW", requiresAuth: false },
  { id: "audio", label: "Audio", icon: Mic, href: "/audio", requiresAuth: false },
