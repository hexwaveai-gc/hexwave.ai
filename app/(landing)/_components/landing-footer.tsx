...
const socialLinks = [
  {
    label: "Twitter",
    href: "https://twitter.com/hexwaveai",
    icon: (
  ...
  {
    label: "YouTube",
    href: "https://youtube.com/@hexwaveai",
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    label: "Instagram",
    href: "https://instagram.com/hexwaveai",
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8 lg:gap-12 mb-12">
          ...
          <div className="col-span-2 md:col-span-4 lg:col-span-1 mb-4 lg:mb-0">
            ...
            <p className="text-white/50 text-sm mb-6 max-w-xs">
              All-in-One AI Creative Studio. Transform your ideas into stunning 
              images, videos, and more with 40+ AI models.
            </p>
        ...
        <div className="pt-8 border-t border-white/10 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-white/40 text-sm">
            © {new Date().getFullYear()} Hexwave.ai. All rights reserved.
          </p>
          
          <div className="flex items-center gap-6">
            <span className="text-white/40 text-sm flex items-center gap-2">
              Made with
              <span className="text-[#74FF52]">💚</span>
              for creators
            </span>
          </div>
        </div>
